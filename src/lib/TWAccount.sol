...
// Base
import "thirdweb-contracts/smart-wallet/utils/BaseAccount.sol";

// Extensions
import "thirdweb-contracts/extension/Multicall.sol";
import "thirdweb-contracts/dynamic-contracts/extension/Initializable.sol";
import "thirdweb-contracts/dynamic-contracts/extension/PermissionsEnumerable.sol";
import "thirdweb-contracts/dynamic-contracts/extension/ContractMetadata.sol";
import "thirdweb-contracts/openzeppelin-presets/token/ERC721/utils/ERC721Holder.sol";
import "thirdweb-contracts/openzeppelin-presets/token/ERC1155/utils/ERC1155Holder.sol";
import "thirdweb-contracts/eip/ERC1271.sol";

// Utils
import "thirdweb-contracts/openzeppelin-presets/utils/cryptography/ECDSA.sol";
import "thirdweb-contracts/smart-wallet/non-upgradeable/AccountFactory.sol";
    ...
    ERC1155Holder
{
    ...
    function initialize(address _defaultAdmin, bytes calldata)
        public
        virtual
        initializer
    {
